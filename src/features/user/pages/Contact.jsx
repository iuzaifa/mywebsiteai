...
const Contact = () => {
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto bg-white dark:bg-slate-950/90 my-5 lg:my-14 p-5 lg:p-10 rounded-md border border-slate-300 dark:border-slate-800 shadow-sm">
        <div className="lg:flex py-8 justify-center max-w-6xl mx-auto px-5 gap-4 lg:py-10 bg-slate-100/50 dark:bg-slate-800/50 rounded-sm">
