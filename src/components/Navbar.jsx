...
const MobileMenu = ({
            ...
            {item.dropdownItems.map((categoryOrItem, i) => {
              ...
              if (categoryOrItem.items) {
                return (
                  <div
                    key={i}
                    className="lg:pt-2 lg:border-t border-gray-200 dark:border-gray-700"
                  >
  ...
  return (
    ...
    <div
      className={`
        lg:hidden fixed top-[49px] sm:top-[50px] left-0 w-full h-[calc(100vh-49px)]
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 sm:px-8 py-2 max-w-7xl mx-auto w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Mobile Menu Button */}
            <button
              className="lg:hidden p-2 text-teal-500 dark:text-gray-200 transition-colors"
              onClick={toggleMenu}
